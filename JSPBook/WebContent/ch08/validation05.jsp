...
<body>
	...
	function CheckMember(){
		...
		// 이메일은 이메일 형식인지 검사하도로고 정규 표현식 작성
		// 처음 시작이 숫자, 영소대문자이고 특수문자 -_/. 나올 수있고 그 다음에 숫자, 영소대문자가 0개 이상이 나온다.
		// @ 이메일 형식과 같은 내용이 이어서 나오게 되는데, \.은 특수문자 /을 표현하지 위해 이스케이프 .이 반드시 나와야하고 영소대문자 2~3자리가 끝에 나타난다.
